...
var cities = ["Shanghai","Jiaxing","Suzhou","Wuxi","Changzhou","Hangzhou","Ningbo","Shaoxing","Zhoushan","Nanjing","Zhenjiang","Ma'anshan","Nantong","Zhangjiagang","Jiangyin","Haimen","Jingjiang","Guangzhou","Foshan","Zhaoqing","Hong Kong","Shenzhen","Dongguan","Huizhou","Macau","Zhuhai","Jiangmen","Zhongshan","Beijing","Tianjin","Tangshan","Baoding","Shijiazhuang","Langfang","Zhangjiakou","Chengde","Cangzhou","Chengdu","Chongqing","Leshan","Luzhou","Mianyang","Nanchong","Yibin","Meishan","Ziyang","Deyang","Suining","Neijiang","Zigong","Jinnan","Qingdao","Shenyang","Dalian","Zhengzhou","Kaifeng","Luoyang","Wuhan","Fuzhou","Xiamen","Quanzhou","Zhangzhou","Ningde","Putian","Xi'an","Xianyang","Baoji","Weinan"];
            ...
            function (e, r, b) {
                ...
                async.mapLimit(searchUrls, 1, function (su, scb) {
                    ...
                    async.mapSeries(items, function (item, cb) {
                        ...
                        fs.writeFileSync('china/' + city + '.json', JSON.stringify(finalItems));
...
process.on('exit', function () {
    fs.writeFileSync('remainingCities_china.txt', remainingCities);
